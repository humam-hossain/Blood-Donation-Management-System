...
public class AllDonorDetails extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabelAddDonorDetails = new javax.swing.JLabel();
        ...
        jLabelAddDonorDetails.setFont(new java.awt.Font("Segoe UI", 1, 36)); // NOI18N
        jLabelAddDonorDetails.setText("Add Donor Details");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(186, 186, 186)
                        .addComponent(jLabelAddDonorDetails)
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try{
            ...
            jTableDonorDetails.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
            jTableDonorDetails.setModel(DbUtils.resultSetToTableModel(rs));
        }catch(Exception e){
    ...
    private void jButtonPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPrintActionPerformed
        // TODO add your handling code here:
        try{
            jTableDonorDetails.print(JTable.PrintMode.NORMAL);
        }catch(Exception e){
            JOptionPane.showMessageDialog(null, e);
            System.out.println(e);
        }
...
//            System.out.println(currentPath);
    ...
    private javax.swing.JLabel jLabelAddDonorDetails;
